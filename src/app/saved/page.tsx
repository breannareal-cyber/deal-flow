...
import { HoldClient } from '@/components/feed/hold-client';

export const dynamic = 'force-dynamic';

export default async function SavedPage() {
  const saved = await getStorage().getSaved();
    ...
    <div className="min-h-screen">
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 sm:px-10 pt-6 pb-16">
          ...
          <p className="text-[0.95rem] mt-4 max-w-md leading-relaxed" style={{ color: '#2f3b41' }}>
            The catches you&rsquo;re tracking. Mark a deal Researched, Contacted, or Pass in the feed and it
            drops into the hold below.
          </p>
        </div>
      ...
      <main style={{ backgroundColor: '#0e1011' }}>
        <div className="max-w-5xl mx-auto px-6 py-16">
          {empty ? (
            <div className="max-w-2xl mx-auto text-center py-20 px-6" style={{ border: '1px solid #2b3137' }}>
              ...
              <p className="text-xs mt-2" style={{ color: '#8b949b' }}>
                Mark any card Researched, Contacted, or Pass in the feed.
              </p>
              <Link
                href="/"
                className="inline-block mt-8 eyebrow text-[11px] px-6 py-3 transition-colors hover:bg-[#c4634b]"
